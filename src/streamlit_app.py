...
st.write(
    "Please enter the patient's characteristics to get a breast cancer prediction."
)

feature_info = {
    "radius_mean": {
        "label": "Mean Radius",
        "description": "Average of distances from center to points on the perimeter.",
    },
    "texture_mean": {
        "label": "Mean Texture",
    ...
    "smoothness_mean": {
        ...
        "description": "Average of local variation in radius lengths.",
    },
    "compactness_mean": {
    ...
    "symmetry_mean": {
        "label": "Mean Symmetry",
        "description": "Symmetry of the core tumor.",
    },
    ...
    "perimeter_se": {
        "label": "SE Perimeter",
        "description": "Standard Error for the mean perimeter.",
    },
    "area_se": {"label": "SE Area", "description": "Standard Error for the mean area."},
    "smoothness_se": {
        "label": "SE Smoothness",
        "description": "Standard Error for the average of local variation in radius lengths.",
    },
    "compactness_se": {
        "label": "SE Compactness",
        "description": "Standard Error for Perimeter^2 / Area - 1.0.",
    },
    "concavity_se": {
        "label": "SE Concavity",
    ...
    "symmetry_se": {
        "label": "SE Symmetry",
        "description": "Standard Error for symmetry of the core tumor.",
    },
    ...
    "radius_worst": {
        "label": "Worst Radius",
        "description": '"Worst" or largest mean value for radius.',
    },
    "texture_worst": {
        "label": "Worst Texture",
        "description": '"Worst" or largest mean value for texture.',
    },
    "perimeter_worst": {
        "label": "Worst Perimeter",
        "description": '"Worst" or largest mean value for perimeter.',
    },
    "area_worst": {
        "label": "Worst Area",
        "description": '"Worst" or largest mean value for area.',
    },
    "smoothness_worst": {
        "label": "Worst Smoothness",
        "description": '"Worst" or largest mean value for smoothness.',
    },
    "compactness_worst": {
        "label": "Worst Compactness",
        "description": '"Worst" or largest mean value for compactness.',
    },
    "concavity_worst": {
        "label": "Worst Concavity",
        "description": '"Worst" or largest mean value for concavity.',
    },
    "concave points_worst": {
        "label": "Worst Concave Points",
        "description": '"Worst" or largest mean value for concave points.',
    },
    "symmetry_worst": {
        "label": "Worst Symmetry",
        "description": '"Worst" or largest mean value for symmetry.',
    },
    "fractal_dimension_worst": {
        "label": "Worst Fractal Dimension",
        "description": '"Worst" or largest mean value for fractal dimension.',
    },
}
    ...
    for i, feature in enumerate(feature_info.keys()):
        with cols[i % num_columns]:
            input_data[feature] = st.number_input(
                ...
                value=0.0,
                format="%.4f",
                help=feature_info[feature]["description"],
        ...
        if response.status_code == 200:
            ...
            with col1:
                st.metric(
                    ...
                    value=f"{result['probability_benign']:.4f}",
                )
            with col2:
                st.metric(
                    label="Malignant Probability",
                    value=f"{result['probability_malignant']:.4f}",
                )

        else:
            st.error(
                f"Error from API: {response.status_code} - {response.json().get('error', 'Unknown error')}"
            )
    except requests.exceptions.ConnectionError:
        st.error(
            "Could not connect to the Flask API. Please ensure it is running at http://localhost:5000."
        )
